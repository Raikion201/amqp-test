...
/**
 * AMQP 1.0 Footer section.
 *
 * Contains post-body annotations, typically for message verification
 * such as message digests or signatures.
 */
public class Footer implements MessageSection {

    public static final long DESCRIPTOR = AmqpType.Descriptor.FOOTER;
    ...
    public Footer(Map<Symbol, Object> annotations) {
    ...
    public Footer put(Symbol key, Object value) {
        annotations.put(key, value);
        return this;
    }

    public Footer put(String key, Object value) {
    ...
    public static Footer decode(DescribedType described) {
