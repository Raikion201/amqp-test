...
/**
 * AMQP 1.0 Delivery Annotations section.
 *
 * Contains delivery-specific annotations for the next hop.
 * These are stripped by the next hop and are not part of the
 * application message.
 */
public class DeliveryAnnotations implements MessageSection {

    public static final long DESCRIPTOR = AmqpType.Descriptor.DELIVERY_ANNOTATIONS;
    ...
    public DeliveryAnnotations(Map<Symbol, Object> annotations) {
    ...
    public SectionType getSectionType() {
        return SectionType.DELIVERY_ANNOTATIONS;
    }
    ...
    public DeliveryAnnotations put(Symbol key, Object value) {
        annotations.put(key, value);
        return this;
    }

    public DeliveryAnnotations put(String key, Object value) {
    ...
    public static DeliveryAnnotations decode(DescribedType described) {
    ...
    public String toString() {
        return "DeliveryAnnotations{" + annotations + "}";
    }
}
